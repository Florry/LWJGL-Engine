package se.florry.engine.display;
...
/*
 * GLFW display, used to display the actual OpenGL game.
 */
public final class Display
{
	...
	public void init()
	{
		...
		// Window creation
		this.window = glfwCreateWindow(Constants.Display.WIDTH, Constants.Display.HEIGHT, this.title, NULL, NULL);
		...
		glfwSetWindowAspectRatio(this.window, Constants.Display.ASPECT_RATIO_NUMERATOR, Constants.Display.ASPECT_RATIO_DENOMINATOR);
		glfwMakeContextCurrent(this.window);
		glfwSwapInterval(1);
		glfwShowWindow(this.window);

		GLFW.glfwSetFramebufferSizeCallback(this.window, resizeWindow);
